...
if __name__ == "__main__":
    ...
    if len(args.config):
        ...
        if config["population"]["individual_type"] == "simple_fw_fc":
            ...
            def make_ag(idx):
                return Agents.Agent1d(idx, min(problem.env.phi_vals),
        ...
        raise Exception(
            "not implemented yet. Technically, it isn't necessary, you can resume just by setting initial_pop in NoveltySearch.__init__"
        )

...
python3.8 -m scoop -n 72 population_priors.py --resume /scratchbeta/salehia/METAWORLD_EXPERIMENTS/META_LOGS/meta-learning_1M48yR21f2_3064/population_prior_3 > log_metaworld_pick_place.txt
